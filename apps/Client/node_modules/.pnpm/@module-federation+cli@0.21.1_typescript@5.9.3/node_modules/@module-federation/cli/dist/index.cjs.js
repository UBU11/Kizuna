...
function runCli(options) {
    const normalizedOptions = Object.assign({ loggerPrefix: PREFIX, welcomeMsg: `${`Module Federation v${"0.21.1"}`}\n`, name: 'mf', readConfig, version: "0.21.1", applyCommands: () => { } }, options);
